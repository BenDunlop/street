...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function fetchPhotos() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_superagent___default.a.get('https://api.instagram.com/v1//tags/{tag-name}/media/recent?access_token=' + access_token).then(function (res) {
        _this2.setState({
...
//# sourceMappingURL=4.fcf18d1fa6d992e9d896.hot-update.js.map